...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_DemoPage_vue__ = __webpack_require__(58);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_DemoPage_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_DemoPage_vue__);
...
new Vue({
    components: {
        DemoPage: __WEBPACK_IMPORTED_MODULE_0__components_DemoPage_vue___default.a
    }
}).$mount('#app');
...
Component.options.__file = "resources/assets/js/components/KdMasonry.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7d7f0c85", Component.options)
  } else {
    hotAPI.reload("data-v-7d7f0c85", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_resize_directive__ = __webpack_require__(40);
...
var _directives$props$dat;

function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }



/* harmony default export */ __webpack_exports__["default"] = (_directives$props$dat = {
    directives: { resize: __WEBPACK_IMPORTED_MODULE_0_vue_resize_directive___default.a },
    props: {
        columns: { default: 3 },
        spacing: { default: 10 }
    },
    ...
    methods: {
        getValueForBreakpoint: function getValueForBreakpoint(orderedProp, width) {
            if (parseInt(orderedProp) > -1) {
                return orderedProp;
            }

            return orderedProp.find(function (breakpoint) {
                return breakpoint.maxWidth >= width;
            }).value;
        },
        orderBreakpoints: function orderBreakpoints(prop) {
            var propAsNumber = parseInt(prop);

            if (propAsNumber > -1) {
                return propAsNumber;
            }

            return Object.keys(prop).sort().map(function (breakpoint) {
                return {
        ...
        updateColumns: function updateColumns() {
            if (window.innerWidth != this.current.width) {
                ...
                this.current.columns = this.getValueForBreakpoint(this.ordered.columns, this.current.width);
                this.current.spacing = this.getValueForBreakpoint(this.ordered.spacing, this.current.width);
            }
        }
    }
}, _defineProperty(_directives$props$dat, 'created', function created() {
    this.updateColumns();
}), _defineProperty(_directives$props$dat, 'render', function render(h) {
    var columns = Array.from(Array(this.current.columns)).map(function (column) {
        return [];
    });
    var tiles = this.$slots.default.filter(function (tile) {
        return tile.tag;
    });
    var styles = {
        column: {
    ...
    for (var i = 0; i < tiles.length; i++) {
        var column = columns[i % this.current.columns];
        column.push(tiles[i]);
...
Component.options.__file = "resources/assets/js/components/DemoPage.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2d29cb49", Component.options)
  } else {
    hotAPI.reload("data-v-2d29cb49", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DemoTile_vue__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__DemoTile_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__DemoTile_vue__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__KdMasonry_vue__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__KdMasonry_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__KdMasonry_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        DemoTile: __WEBPACK_IMPORTED_MODULE_0__DemoTile_vue___default.a,
        KdMasonry: __WEBPACK_IMPORTED_MODULE_1__KdMasonry_vue___default.a
    },
    data: function data() {
        return {
            items: Array.from({ length: 8 }, function (_, index) {
                return index + 1;
            }),
            message: '',
            value: 0
    ...
    methods: {
        ...
        alert: function alert(tile) {
            this.message = 'Tile ' + tile.index + ' was clicked, value is ' + tile.value;
        }
    }
});
...
Component.options.__file = "resources/assets/js/components/DemoTile.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7c6893e8", Component.options)
  } else {
    hotAPI.reload("data-v-7c6893e8", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            randomHeight: Math.round(Math.random() * (100 - 10) + 10)
        };
    }
});
  ...
  return _c(
    "div",
    {
      style: {
        ...
        padding: _vm.randomHeight + "px 10px",
        textAlign: "center"
      },
      on: {
        click: function($event) {
          _vm.$emit("alert", { index: _vm.index, value: _vm.value })
        }
      }
    },
    [
      ...
      _vm._v(" "),
      _c("h2", [_vm._v("Value: " + _vm._s(_vm.value))])
    ]
  )
}
var staticRenderFns = []
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7c6893e8", module.exports)
  }
}
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "container", style: { margin: "20px" } },
    [
      _c(
        "div",
        {
      ...
      _c(
        ...
        _vm._l(_vm.items, function(item, index) {
          return _c("DemoTile", {
            key: index,
            attrs: { value: item + _vm.value, index: index },
            on: { alert: _vm.alert }
          })
        })
      )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2d29cb49", module.exports)
  }
}
